...
2.  This picture is an example of successful login.  Logout

  ![](images/login-success.png)

3.  Login using SSP Project Admin username provided in the Google spreadsheet.  An example is tenant20projadm@ntnxlab1.local

  ![](images/login-proj-admin.png)

4.  This picture is an example of successful login.  
